...
contract Claiming {
    ...
    function claimTokens(uint32 _projectId) public {
        ...
        if (reward != 0) {
            ...
            (uint amountSteps,,, uint[] memory dateSteps,,,) = createProject_contract.projectsViewSteps(_projectId);
    ...
    function earned(uint32 _projectId, address _account) public view returns (uint) {
        ...
        (uint amountSteps,, uint[] memory rewardTimePerStep, uint[] memory dateSteps, bool[] memory isStepsPerProject,,)
