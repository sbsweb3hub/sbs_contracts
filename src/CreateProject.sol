...
contract CreateProject is ProjectManagerMain, ProjectManagerPrice, ProjectManagerSteps {
    ...
    function setApproveClaimAddresses(uint32 _projectId, address _claimableAddr, address _getFundForProjectAddr)
        private
    {
        (ProjectToken projectContract, address owner,,) = projectsViewMain(_projectId);
